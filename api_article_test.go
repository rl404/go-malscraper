...
func TestGetArticle(t *testing.T) {
	t.Run("related-ok", func(t *testing.T) {
		d, code, err := mal.GetArticle(2321)
		require.NotNil(t, d)
	...
	t.Run("tag-ok", func(t *testing.T) {
		d, code, err := mal.GetArticle(1821)
		require.NotNil(t, d)
		require.Equal(t, code, http.StatusOK)
		require.NoError(t, err)
...
func TestGetArticles(t *testing.T) {
	...
	t.Run("with-tag-ok", func(t *testing.T) {
		d, code, err := mal.GetArticles(1, "recap")
		require.NotNil(t, d)
		require.Equal(t, code, http.StatusOK)
		require.NoError(t, err)
