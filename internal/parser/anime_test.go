...
func TestGetAnime(t *testing.T) {
	...
	t.Run("ok", func(t *testing.T) {
		d, code, err := parser.GetAnime(1412)
		require.NotNil(t, d)
...
func TestGetAnimeCharacter(t *testing.T) {
	parser := New(true, true, log)
	t.Run("not-found", func(t *testing.T) {
		d, code, err := parser.GetAnimeCharacter(0)
		assert.Nil(t, d)
		assert.Equal(t, code, http.StatusNotFound)
		assert.Error(t, err)
		assert.EqualError(t, err, errors.ErrNot200.Error())
	...
	t.Run("ok", func(t *testing.T) {
		d, code, err := parser.GetAnimeCharacter(32281)
		require.NotNil(t, d)
		require.Equal(t, code, http.StatusOK)
		require.NoError(t, err)
...
func TestGetAnimeStaff(t *testing.T) {
	parser := New(true, true, log)
	t.Run("not-found", func(t *testing.T) {
		d, code, err := parser.GetAnimeStaff(0)
		assert.Nil(t, d)
		assert.Equal(t, code, http.StatusNotFound)
		assert.Error(t, err)
		assert.EqualError(t, err, errors.ErrNot200.Error())
	...
	t.Run("ok", func(t *testing.T) {
		d, code, err := parser.GetAnimeStaff(1)
		require.NotNil(t, d)
		require.Equal(t, code, http.StatusOK)
		require.NoError(t, err)
		require.NotZero(t, len(d))
...
func TestGetAnimeVideo(t *testing.T) {
	...
	t.Run("no-found", func(t *testing.T) {
		d, code, err := parser.GetAnimeVideo(0, 0)
		assert.Nil(t, d)
		assert.Equal(t, code, http.StatusNotFound)
		assert.Error(t, err)
		assert.EqualError(t, err, errors.ErrNot200.Error())
	...
	t.Run("ok", func(t *testing.T) {
		d, code, err := parser.GetAnimeVideo(1, 1)
		require.NotNil(t, d)
		require.Equal(t, code, http.StatusOK)
		require.NoError(t, err)
...
func TestGetAnimeEpisode(t *testing.T) {
	parser := New(true, true, log)
	t.Run("not-found", func(t *testing.T) {
		d, code, err := parser.GetAnimeEpisode(0, 0)
		assert.Nil(t, d)
		assert.Equal(t, code, http.StatusNotFound)
		assert.Error(t, err)
		assert.EqualError(t, err, errors.ErrNot200.Error())
	...
	t.Run("ok", func(t *testing.T) {
		d, code, err := parser.GetAnimeEpisode(20, 1)
		require.NotNil(t, d)
		require.Equal(t, code, http.StatusOK)
		require.NoError(t, err)
		require.NotZero(t, len(d))
...
func TestGetAnimeStats(t *testing.T) {
	parser := New(true, true, log)
	t.Run("not-found", func(t *testing.T) {
		d, code, err := parser.GetAnimeStats(0)
		assert.Nil(t, d)
		assert.Equal(t, code, http.StatusNotFound)
		assert.Error(t, err)
		assert.EqualError(t, err, errors.ErrNot200.Error())
	...
	t.Run("ok", func(t *testing.T) {
		d, code, err := parser.GetAnimeStats(1)
		require.NotNil(t, d)
		require.Equal(t, code, http.StatusOK)
		require.NoError(t, err)
...
func TestGetAnimeReview(t *testing.T) {
	parser := New(true, true, log)
	t.Run("not-found", func(t *testing.T) {
		d, code, err := parser.GetAnimeReview(0, 1)
		assert.Nil(t, d)
		assert.Equal(t, code, http.StatusNotFound)
		assert.Error(t, err)
		assert.EqualError(t, err, errors.ErrNot200.Error())
	...
	t.Run("ok", func(t *testing.T) {
		d, code, err := parser.GetAnimeReview(1, 1)
		require.NotNil(t, d)
		require.Equal(t, code, http.StatusOK)
		require.NoError(t, err)
		require.NotZero(t, len(d))
...
func TestGetAnimeRecommendation(t *testing.T) {
	parser := New(true, true, log)
	t.Run("not-found", func(t *testing.T) {
		d, code, err := parser.GetAnimeRecommendation(0)
		assert.Nil(t, d)
		assert.Equal(t, code, http.StatusNotFound)
		assert.Error(t, err)
		assert.EqualError(t, err, errors.ErrNot200.Error())
	...
	t.Run("ok", func(t *testing.T) {
		d, code, err := parser.GetAnimeRecommendation(1)
		require.NotNil(t, d)
		require.Equal(t, code, http.StatusOK)
		require.NoError(t, err)
		require.NotZero(t, len(d))
...
func TestGetAnimeNews(t *testing.T) {
	parser := New(true, true, log)
	t.Run("not-found", func(t *testing.T) {
		d, code, err := parser.GetAnimeNews(0)
		assert.Nil(t, d)
		assert.Equal(t, code, http.StatusNotFound)
		assert.Error(t, err)
		assert.EqualError(t, err, errors.ErrNot200.Error())
	...
	t.Run("ok", func(t *testing.T) {
		d, code, err := parser.GetAnimeNews(1)
		require.NotNil(t, d)
		require.Equal(t, code, http.StatusOK)
		require.NoError(t, err)
		require.NotZero(t, len(d))
...
func TestGetAnimeArticle(t *testing.T) {
	parser := New(true, true, log)
	t.Run("not-found", func(t *testing.T) {
		d, code, err := parser.GetAnimeArticle(0)
		assert.Nil(t, d)
		assert.Equal(t, code, http.StatusNotFound)
		assert.Error(t, err)
		assert.EqualError(t, err, errors.ErrNot200.Error())
	...
	t.Run("ok", func(t *testing.T) {
		d, code, err := parser.GetAnimeArticle(235)
		require.NotNil(t, d)
		require.Equal(t, code, http.StatusOK)
		require.NoError(t, err)
		require.NotZero(t, len(d))
...
func TestGetAnimeClub(t *testing.T) {
	parser := New(true, true, log)
	t.Run("not-found", func(t *testing.T) {
		d, code, err := parser.GetAnimeClub(0)
		assert.Nil(t, d)
		assert.Equal(t, code, http.StatusNotFound)
		assert.Error(t, err)
		assert.EqualError(t, err, errors.ErrNot200.Error())
	...
	t.Run("ok", func(t *testing.T) {
		d, code, err := parser.GetAnimeClub(1)
		require.NotNil(t, d)
		require.Equal(t, code, http.StatusOK)
		require.NoError(t, err)
		require.NotZero(t, len(d))
...
func TestGetAnimePicture(t *testing.T) {
	parser := New(true, true, log)
	t.Run("not-found", func(t *testing.T) {
		d, code, err := parser.GetAnimePicture(0)
		assert.Nil(t, d)
		assert.Equal(t, code, http.StatusNotFound)
		assert.Error(t, err)
		assert.EqualError(t, err, errors.ErrNot200.Error())
	...
	t.Run("ok", func(t *testing.T) {
		d, code, err := parser.GetAnimePicture(1)
		require.NotNil(t, d)
		require.Equal(t, code, http.StatusOK)
		require.NoError(t, err)
		require.NotZero(t, len(d))
...
func TestGetAnimeMoreInfo(t *testing.T) {
	parser := New(true, true, log)
	t.Run("not-found", func(t *testing.T) {
		d, code, err := parser.GetAnimeMoreInfo(0)
		assert.Empty(t, d)
		assert.Equal(t, code, http.StatusNotFound)
		assert.Error(t, err)
		assert.EqualError(t, err, errors.ErrNot200.Error())
	...
	t.Run("ok", func(t *testing.T) {
		d, code, err := parser.GetAnimeMoreInfo(1)
