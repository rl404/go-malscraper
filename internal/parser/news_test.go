...
func TestGetNews(t *testing.T) {
	...
	t.Run("related-ok", func(t *testing.T) {
		d, code, err := parser.GetNews(34036779)
		require.NotNil(t, d)
	...
	t.Run("tag-ok", func(t *testing.T) {
		d, code, err := parser.GetNews(61210693)
		require.NotNil(t, d)
		require.Equal(t, code, http.StatusOK)
		require.NoError(t, err)
...
func TestGetNewsList(t *testing.T) {
	...
	t.Run("invalid-tag", func(t *testing.T) {
		d, code, err := parser.GetNewsList(1, "random")
		assert.Nil(t, d)
		assert.Equal(t, code, http.StatusNotFound)
		assert.Error(t, err)
		assert.EqualError(t, err, errors.ErrNot200.Error())
	...
	t.Run("no-tag-ok", func(t *testing.T) {
		d, code, err := parser.GetNewsList(2, "")
		require.NotNil(t, d)
		require.Equal(t, code, http.StatusOK)
		require.NoError(t, err)
	...
	t.Run("with-tag-ok", func(t *testing.T) {
		d, code, err := parser.GetNewsList(2, "new_anime")
		require.NotNil(t, d)
		require.Equal(t, code, http.StatusOK)
		require.NoError(t, err)
