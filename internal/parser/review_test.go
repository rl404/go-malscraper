...
func TestGetReview(t *testing.T) {
	...
	t.Run("manga-ok", func(t *testing.T) {
		d, code, err := parser.GetReview(209071)
		require.NotNil(t, d)
		require.Equal(t, code, http.StatusOK)
		require.NoError(t, err)
...
func TestGetReviews(t *testing.T) {
	...
	t.Run("ok-anime", func(t *testing.T) {
		d, code, err := parser.GetReviews("anime", 1)
		require.NotNil(t, d)
		require.Equal(t, code, http.StatusOK)
		require.NoError(t, err)
	...
	t.Run("ok-manga", func(t *testing.T) {
		d, code, err := parser.GetReviews("manga", 1)
		require.NotNil(t, d)
		require.Equal(t, code, http.StatusOK)
		require.NoError(t, err)
	...
	t.Run("ok-best", func(t *testing.T) {
		d, code, err := parser.GetReviews("bestvoted", 1)
		require.NotNil(t, d)
		require.Equal(t, code, http.StatusOK)
		require.NoError(t, err)
