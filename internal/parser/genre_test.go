...
func TestGetGenres(t *testing.T) {
	...
	t.Run("invalid-type", func(t *testing.T) {
		d, code, err := parser.GetGenres("random")
		assert.Nil(t, d)
	...
	t.Run("ok-anime", func(t *testing.T) {
		d, code, err := parser.GetGenres("anime")
		require.NotNil(t, d)
	...
	t.Run("ok-manga", func(t *testing.T) {
		d, code, err := parser.GetGenres("manga")
		require.NotNil(t, d)
		require.Equal(t, code, http.StatusOK)
		require.NoError(t, err)
...
func TestGetAnimeWithGenre(t *testing.T) {
	...
	t.Run("invalid-id", func(t *testing.T) {
		d, code, err := parser.GetAnimeWithGenre(0, 1)
		assert.Nil(t, d)
		assert.Equal(t, code, http.StatusNotFound)
		assert.Error(t, err)
		assert.EqualError(t, err, errors.ErrNot200.Error())
	...
	t.Run("ok", func(t *testing.T) {
		d, code, err := parser.GetAnimeWithGenre(1, 1)
		require.NotNil(t, d)
		require.Equal(t, code, http.StatusOK)
		require.NoError(t, err)
...
func TestGetMangaWithGenre(t *testing.T) {
	parser := New(true, true, log)
	t.Run("invalid-id", func(t *testing.T) {
		d, code, err := parser.GetMangaWithGenre(0, 1)
		assert.Nil(t, d)
		assert.Equal(t, code, http.StatusNotFound)
		assert.Error(t, err)
		assert.EqualError(t, err, errors.ErrNot200.Error())
	...
	t.Run("ok", func(t *testing.T) {
		d, code, err := parser.GetMangaWithGenre(1, 1)
		require.NotNil(t, d)
		require.Equal(t, code, http.StatusOK)
		require.NoError(t, err)
