...
func TestGetMangaReview(t *testing.T) {
	d, code, err := mal.GetMangaReview(1, 1)
	require.NotNil(t, d)
	require.Equal(t, code, http.StatusOK)
	require.NoError(t, err)
...
func TestGetMangaRecommendation(t *testing.T) {
	d, code, err := mal.GetMangaRecommendation(1)
	require.NotNil(t, d)
	require.Equal(t, code, http.StatusOK)
	require.NoError(t, err)
	require.NotZero(t, len(d))
...
func TestGetMangaStats(t *testing.T) {
	d, code, err := mal.GetMangaStats(1)
	require.NotNil(t, d)
	require.Equal(t, code, http.StatusOK)
	require.NoError(t, err)
...
func TestGetMangaCharacter(t *testing.T) {
	d, code, err := mal.GetMangaCharacter(1)
	require.NotNil(t, d)
	require.Equal(t, code, http.StatusOK)
	require.NoError(t, err)
	require.NotZero(t, len(d))
...
func TestGetMangaArticle(t *testing.T) {
	d, code, err := mal.GetMangaArticle(25)
	require.NotNil(t, d)
	require.Equal(t, code, http.StatusOK)
	require.NoError(t, err)
	require.NotZero(t, len(d))
...
func TestGetMangaPicture(t *testing.T) {
	d, code, err := mal.GetMangaPicture(1)
	require.NotNil(t, d)
	require.Equal(t, code, http.StatusOK)
	require.NoError(t, err)
	require.NotZero(t, len(d))
...
func TestGetMangaMoreInfo(t *testing.T) {
	d, code, err := mal.GetMangaMoreInfo(2)
